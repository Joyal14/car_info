...
//
//     final filterSearchModel = filterSearchModelFromJson(jsonString);

import 'dart:convert';

FilterSearchModel filterSearchModelFromJson(String str) =>
    FilterSearchModel.fromJson(json.decode(str));

String filterSearchModelToJson(FilterSearchModel data) =>
...
class FilterSearchModel {
  ...
  factory FilterSearchModel.fromJson(Map<String, dynamic> json) =>
      FilterSearchModel(
...
class Doc {
  ...
  factory Doc.fromJson(Map<String, dynamic> json) => Doc(
        ...
        sellingStatus: sellingStatusValues.map[json["sellingStatus"]]!,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "videoLink": videoLink,
        "sellingStatus": sellingStatusValues.reverse[sellingStatus],
...
class BodytypeDataClass {
  ...
  factory BodytypeDataClass.fromJson(Map<String, dynamic> json) =>
      BodytypeDataClass(
        ...
        v: json["__v"],
        color: json["color"],
        transmissionType: transmissionTypeValues.map[json["transmissionType"]]!,
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "__v": v,
        "color": color,
        "transmissionType": transmissionTypeValues.reverse[transmissionType],
      };
}
...
enum SellingStatus { UNSOLD }

final sellingStatusValues = EnumValues({"unsold": SellingStatus.UNSOLD});
...
class ShowroomDatum {
  ...
  factory ShowroomDatum.fromJson(Map<String, dynamic> json) => ShowroomDatum(
        ...
        sellerType: sellerTypeValues.map[json["sellerType"]]!,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "sellerType": sellerTypeValues.reverse[sellerType],
        "carcount": carcount,
      };
}

enum SellerType { SHOWROOM_SELLER }

final sellerTypeValues =
    EnumValues({"showroom seller": SellerType.SHOWROOM_SELLER});
